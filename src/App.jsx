...
const cars = [
  { id: 1, name: "Renault Logan", category: "Эконом", price: 25, seats: 5, transmission: "Механика", fuel: "Бензин", engine: "1.6 л / 82 л.с.", year: 2022, image: "https://cdn.pixabay.com/photo/2012/05/29/00/43/car-49278_640.jpg", rating: 4.8, reviews: 124, deposit: 150, available: true, features: ["Кондиционер", "USB", "ABS", "Центральный замок", "Электростёкла"], mileage: "Без ограничений", minAge: 21, minLicense: "2 года" },
  { id: 2, name: "Volkswagen Polo", category: "Эконом", price: 32, seats: 5, transmission: "Автомат", fuel: "Бензин", engine: "1.6 л / 110 л.с.", year: 2023, image: "https://cdn.pixabay.com/photo/2016/04/01/12/16/car-1300629_640.png", rating: 4.9, reviews: 98, deposit: 200, available: true, features: ["Кондиционер", "Bluetooth", "ABS", "ESP", "Круиз-контроль", "Парктроник"], mileage: "Без ограничений", minAge: 21, minLicense: "2 года" },
  { id: 3, name: "Toyota Camry", category: "Комфорт", price: 55, seats: 5, transmission: "Автомат", fuel: "Бензин", engine: "2.5 л / 181 л.с.", year: 2023, image: "https://cdn.pixabay.com/photo/2017/03/27/14/56/auto-2179220_640.jpg", rating: 4.7, reviews: 76, deposit: 300, available: true, features: ["Климат-контроль", "Bluetooth", "Камера заднего вида", "Круиз-контроль", "Кожаный салон", "Навигация"], mileage: "Без ограничений", minAge: 23, minLicense: "3 года" },
  { id: 4, name: "Hyundai Tucson", category: "SUV", price: 65, seats: 5, transmission: "Автомат", fuel: "Дизель", engine: "2.0 л / 155 л.с.", year: 2022, image: "https://cdn.pixabay.com/photo/2017/08/31/05/23/jeep-2699898_640.jpg", rating: 4.9, reviews: 203, deposit: 350, available: true, features: ["Климат-контроль", "Полный привод", "Камера 360°", "Bluetooth", "Подогрев сидений", "Люк"], mileage: "Без ограничений", minAge: 23, minLicense: "3 года" },
  { id: 5, name: "Mercedes C-Class", category: "Премиум", price: 95, seats: 5, transmission: "Автомат", fuel: "Бензин", engine: "2.0 л / 204 л.с.", year: 2024, image: "https://cdn.pixabay.com/photo/2016/11/18/12/51/automobile-1834274_640.jpg", rating: 5.0, reviews: 45, deposit: 500, available: false, features: ["Климат-контроль", "Кожа Nappa", "Панорамная крыша", "Навигация", "Вентиляция сидений", "HUD", "Harman Kardon"], mileage: "300 км/день", minAge: 25, minLicense: "5 лет" },
  { id: 6, name: "Ford Transit", category: "Минивэн", price: 75, seats: 8, transmission: "Механика", fuel: "Дизель", engine: "2.0 л / 130 л.с.", year: 2021, image: "https://cdn.pixabay.com/photo/2013/07/13/01/19/mini-bus-155743_640.png", rating: 4.6, reviews: 67, deposit: 400, available: true, features: ["Кондиционер", "Большой багажник", "ABS", "ESP", "USB", "Bluetooth"], mileage: "Без ограничений", minAge: 25, minLicense: "3 года" },
];
